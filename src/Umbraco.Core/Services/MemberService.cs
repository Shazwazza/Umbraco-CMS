...
namespace Umbraco.Core.Services
{
    ...
    public class MemberService : RepositoryService, IMemberService
    {
            ...
            using (var uow = UowProvider.CreateUnitOfWork())
            {
                ...
                switch (countType)
                {
                    ...
                    case MemberCountType.Online:
                        throw new NotSupportedException("TODO: Fix member service for getting online user count - not sure if we can do this with Identity");
        ...
        {
            throw new NotImplementedException("TODO: Fix Member service for password storage - this needs to integrate with Identity");
