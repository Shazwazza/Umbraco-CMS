...
{
    //NOTE: The below is copied from EF - i don't understand why MS chooses to not put these models into a separate re-usable library
    // but oh well, we don't want to reference EF, so we'll copy here.
    ...
    public class IdentityUser<TKey> where TKey : IEquatable<TKey>
    {
        ...
        /// </summary>
        public virtual ICollection<IIdentityUserLogin> Logins { get; } = new List<IIdentityUserLogin>();
